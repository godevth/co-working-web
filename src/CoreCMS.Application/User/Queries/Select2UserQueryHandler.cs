...
{
    public class Select2UserQueryHandler : BaseDbContextHandler<Select2UserQuery,OptionViewModel[]>
    {
        public Select2UserQueryHandler(ApplicationDbContext context) : base(context)
        {
        }

        public override async Task<OptionViewModel[]> Handle(Select2UserQuery request, CancellationToken cancellationToken)
        {

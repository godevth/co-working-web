          ...
          <template v-slot:body>
              ...
              <div class="row">
                <div class="col-9">
                  <v-text-field
                    ...
                    :hint="$t('FACILITY_TPYE.SEARCH.KEYWORD_HINT')"
            ...
            <v-subheader>
              ...
              >
                ...
                {{ $t("FACILITY_TPYE._FACILITY_TPYE.ADD") }}
              </v-btn>
            </v-subheader>
...
export default {
  ...
  data() {
    return {
      ...
      datatable: {
        headers: [
          {
            text: this.$t("FACILITY_TPYE.SEARCH.NAME_TH"),
            value: "name_TH",
            align: "center",
          },
          {
            text: this.$t("FACILITY_TPYE.SEARCH.NAME_EN"),
            value: "name_EN",
            align: "center",
          },
          {
            text: this.$t("FACILITY_TPYE.SEARCH.IN_ACTIVE_STATUS"),
            value: "inActiveStatus",
            align: "center",
          },
          {
            text: this.$t("FACILITY_TPYE.SEARCH.ACTION"),
            value: "id",
            align: "center",
            sortable: false,
            width: "10%"
  ...
  methods: {
    ...
    getDataFromApi() {
      ...
      return new Promise((resolve) => {
        ...
        ApiService.post("/Api/FacilityType/Search", {
    ...
    editItem(id){
      this.$router.push({ name: "editFacilityType", params: { id } });
    },
    ...
    confirmDeleteItem(){
      ...
      ApiService.setHeader();
      ApiService.update("/Api/FacilityType", this.datatable.deleteDialogId +"/Delete")
        .then(({ data }) => {
          //console.log(data);
          this.datatable.dialog = true;
          if (data.message) {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [
      { title: this.$t("FACILITY_TPYE._FACILITY_TPYE.SECTION"), route: "/facilityType" },
      { title: this.$t("FACILITY_TPYE._FACILITY_TPYE.SEARCH") },
    ]);
  },
  computed: {
    title() {
      return this.$t("FACILITY_TPYE._FACILITY_TPYE.SEARCH");
    },
  },
  watch: {
    "datatable.options": {

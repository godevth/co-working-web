            ...
            >
              ...
              <v-dialog v-model="form.dialog" persistent max-width="300">
                <v-card>
                  ...
                  >
                  <v-card-text>
                      {{ $t("FACILITY_TPYE.ADD_EDIT.ADD_SUCCESS_DIALOG_TEXT") }}
                  </v-card-text>
                  <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn
...
export default {
  ...
  computed: {
    title() {
      return this.$t("FACILITY_TPYE._FACILITY_TPYE.ADD");
    },
  },
  watch: {
  ...
  methods: {
    ...
    postDataToApi() {
      ...
      ApiService.post("/Api/FacilityType/Add", 
      {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [
      ...
      { title: this.$t("FACILITY_TPYE._FACILITY_TPYE.ADD") },
    ]);
  },
};
</script>

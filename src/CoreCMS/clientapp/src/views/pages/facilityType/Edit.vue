              ...
              <v-row>
                ...
                >
                  <v-text-field
                    ...
                    :counter="50"
                    :label="$t('FACILITY_TPYE.ADD_EDIT.NAME_TH')"
                ...
                >
                  <v-text-field
                    ...
                    :disabled="form.loading"
                    :counter="50"
                    :label="$t('FACILITY_TPYE.ADD_EDIT.NAME_EN')"
...
export default {
  ...
  methods: {
    ...
    postDataToApi() {
      ...
      ApiService.put("/Api/FacilityType/Edit", {
        Id: this.form.id,
    ...
    closeDialog() {
      ...
      this.$router.push({ name: "searchFacilityType" });
    },
    getDataFromApi(id) {
      this.form.loading = true;
      return new Promise(() => {
        ApiService.setHeader();
        ApiService.get("/Api/FacilityType", id)
          .then(({ data }) => {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [
      { title: this.$t("FACILITY_TPYE._FACILITY_TPYE.SECTION"), route: "/PlaceType" },
      { title: this.$t("FACILITY_TPYE._FACILITY_TPYE.EDIT") }
    ]);

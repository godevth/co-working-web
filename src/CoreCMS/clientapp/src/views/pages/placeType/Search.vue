          ...
          <template v-slot:body>
            ...
            <v-subheader>
              ...
              >
                ...
                {{ $t("LOCATION_TPYE._LOCATION_TPYE.ADD") }}
              </v-btn>
            </v-subheader>
...
export default {
  ...
  data() {
    return {
      ...
      datatable: {
        headers: [
          {
            text: this.$t("LOCATION_TPYE.SEARCH.NAME_TH"),
            value: "name",
            align: "center",
          },
          {
            text: this.$t("LOCATION_TPYE.SEARCH.NAME_EN"),
            value: "nameEN",
            align: "center",
          },
          {
  ...
  methods: {
    ...
    getDataFromApi() {
      ...
      return new Promise((resolve) => {
        ...
        ApiService.post("/Api/PlaceType/Search", {
    ...
    editItem(id){
      this.$router.push({ name: "editPlaceType", params: { id } });
    },
    ...
    confirmDeleteItem(){
      ...
      ApiService.setHeader();
      ApiService.update("/Api/PlaceType", this.datatable.deleteDialogId +"/Delete")
        .then(({ data }) => {
          //console.log(data);
          this.datatable.dialog = true;
          if (data.message) {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [
      { title: this.$t("LOCATION_TPYE._LOCATION_TPYE.SECTION"), route: "/placeType" },

                ...
                <KTPortlet v-bind:title="title">
                    <template v-slot:body>
                      ...
                      $t("LOCATION_TPYE.ADD_EDIT.SUCCESS_DIALOG_HEADER")
                                    ...
                                    <v-card-text>
                                        {{ $t("LOCATION_TPYE.ADD_EDIT.EDIT_SUCCESS_DIALOG_TEXT") }}
                                    </v-card-text>
                                    <v-card-actions>
                                        <v-spacer></v-spacer>
...
<script>
    ...
    export default {
        ...
        computed: {
            title() {
                return this.$t("LOCATION_TPYE._LOCATION_TPYE.EDIT");
            }
        },
        watch: {
        ...
        methods: {
            ...
            postDataToApi() {
                ...
                ApiService.put("/Api/PlaceType/Edit", {
                    Id: this.form.id,
                    Name: this.form.name,
            ...
            getDataFromApi(id) {
                ...
                return new Promise(() => {
                    ApiService.setHeader();
                    ApiService.get("/Api/PlaceType", id)
                        .then(({ data }) => {
        ...
        mounted() {
            this.$store.dispatch(SET_BREADCRUMB, [
                ...
                { title: this.$t("LOCATION_TPYE._LOCATION_TPYE.EDIT") }
            ]);

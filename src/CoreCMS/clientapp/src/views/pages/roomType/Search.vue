              ...
              <div class="row">
                <div class="col-9">
                  <v-text-field
                    ...
                    :hint="$t('ROOM_TPYE.SEARCH.KEYWORD_HINT')"
                ...
                <div class="col-3">
                  <v-autocomplete
                    ...
                    item-text="text"
                    item-value="value"
                    :label="$t('ROOM_TPYE.SEARCH.IN_ACTIVE_STATUS')"
                    :placeholder="
...
export default {
  ...
  data() {
    return {
      ...
      datatable: {
        headers: [
          {
            text: this.$t("ROOM_TPYE.SEARCH.NAME_TH"),
            value: "name",
            align: "center",
          },
          {
            text: this.$t("ROOM_TPYE.SEARCH.NAME_EN"),
            value: "nameEN",
            align: "center",
          },
          {
            text: this.$t("ROOM_TPYE.SEARCH.IN_ACTIVE_STATUS"),
            value: "inActiveStatus",
            align: "center",
          },
          {
            text: this.$t("ROOM_TPYE.SEARCH.ACTION"),
            value: "id",
            align: "center",
            sortable: false,
            width: "10%"
  ...
  methods: {
    ...
    getDataFromApi() {
      ...
      return new Promise((resolve) => {
        ...
        ApiService.post("/Api/RoomType/Search", {
    ...
    editItem(id){
      this.$router.push({ name: "editRoomType", params: { id } });
    },
    ...
    confirmDeleteItem(){
      ...
      ApiService.setHeader();
      ApiService.update("/Api/RoomType", this.datatable.deleteDialogId +"/Delete")
        .then(({ data }) => {
          //console.log(data);
          this.datatable.dialog = true;
          if (data.message) {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [
      ...
      { title: this.$t("ROOM_TPYE._ROOM_TPYE.SEARCH") },
    ]);
  },
  computed: {
    title() {
      return this.$t("ROOM_TPYE._ROOM_TPYE.SEARCH");
    },
  },
  watch: {
    "datatable.options": {

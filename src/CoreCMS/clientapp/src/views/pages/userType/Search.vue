        ...
        <div class="row">
            <div class="col-md-12">
                <KTPortlet v-bind:title="title">
                    <template v-slot:body>
                        <v-form ref="form" @submit.prevent="submitForm">
                            <div class="row">
                                <div class="col-9">
                                    <v-text-field v-model="form.searchKeyword"
                                                  :disabled="datatable.loading"
                                                  :label="$t('SHARED.KEYWORD')"
                                                  :hint="$t('USER_TYPE.SEARCH.KEYWORD_HINT')"
                                                  prepend-icon="mdi-file-document-box-search-outline"></v-text-field>

                                    <!--<div class="col-3">
                                        <v-autocomplete v-model="form.inActiveStatus"
                                                        :disabled="datatable.loading"
                                                        ...
                                                        item-text="text"
                                                        item-value="value"
                                                        :label="$t('ROLE.SEARCH.IN_ACTIVE_STATUS')"
                                                        :placeholder="
                    ...
                    "
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <v-btn :disabled="datatable.loading"
                                           color="success"
                                           class="mr-4"
                                           tile
                                           type="submit">
                ...
                'items-per-page-options': [30, 50, 100],
                            ...
                            <template v-slot:item.inActiveStatus="{ item }">
                              <v-btn
                                :color="getInActiveStatusColor(item.inActiveStatus)"
                                  class="mr-4"
                                  tile
                                  @click="toggleItem(item.id,item.inActiveStatus)"
                              >
                        ...
                        <v-dialog v-model="datatable.loading"
                                  persistent
                                  width="300">
                            <v-card>
                        ...
                        <v-dialog v-model="datatable.toggleDialog"
                                  persistent
                                  max-width="300">
                            <v-card>
                                <v-card-title class="headline">
                        ...
                        <v-dialog v-model="datatable.deleteDialog"
                                  persistent
                                  max-width="300">
                            <v-card>
                                <v-card-title class="headline">
    ...
    export default {
        ...
        data() {
            return {
                ...
                datatable: {
                    headers: [
                        {
                            text: this.$t("USER_TYPE.SEARCH.NAME"),
                            value: "name",
                            align: "center",
                        },
                        {
                            text: this.$t("USER_TYPE.SEARCH.DESCRIPTION"),
                            value: "description",
                            align: "center",
                        },
                        {
                          text: this.$t("USER_TYPE.SEARCH.IN_ACTIVE_STATUS"),
                          value: "inActiveStatus",
                          align: "center",
                        },
                        {
                            text: this.$t("USER_TYPE.SEARCH.ACTION"),
                            value: "id",
                            align: "center",
                            sortable: false,
                            width: "10%"
        ...
        methods: {
            ...
            getDataFromApi() {
                ...
                return new Promise((resolve) => {
                    ...
                    ApiService.post("/Api/UserType/Search", {
            ...
            editItem(id) {
                this.$router.push({ name: "editUserType", params: { id } });
            },
            ...
            confirmToggleItem(){
              ...
              ApiService.setHeader();
              ApiService.put("/Api/UserType/Toggle",{
                    UserTypeId: this.datatable.toggleDialogId
                })
                .then(({ data }) => {
                  //console.log(data);
            ...
            confirmDeleteItem() {
                ...
                ApiService.setHeader();
                ApiService.update("/Api/UserType", this.datatable.deleteDialogId + "/Delete")
                    .then(({ data }) => {
                        //console.log(data);
                        this.datatable.dialog = true;
                        if (data.message) {
        ...
        mounted() {
            this.$store.dispatch(SET_BREADCRUMB, [
                { title: this.$t("MENU.USER_TYPE.SECTION"), route: "/userType" },
                { title: this.$t("MENU.USER_TYPE.SEARCH") },
            ]);
        },
        computed: {
            title() {
                return this.$t("MENU.USER_TYPE.SEARCH");
            },
        },
        watch: {
            "datatable.options": {

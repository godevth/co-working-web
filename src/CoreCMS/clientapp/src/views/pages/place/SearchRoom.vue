          ...
          <template v-slot:body>
            <v-col cols="12" md="12">
              <v-text-field
                ...
                :disabled="true"
                :label="$t('ROOM.SEARCH.PLACE_NAME')"
                required
              ></v-text-field>
            </v-col>
              ...
              <div class="row">
                ...
                <div class="col-3">
                  <v-autocomplete
                    ...
                    item-text="text"
                    item-value="value"
                    :label="$t('LOCATION_TPYE.SEARCH.IN_ACTIVE_STATUS')"
                    :placeholder="$t('SHARED.START_TYPING_TO_SEARCH')"
                    prepend-icon="mdi-database-search"
                    return-object
                    clearable
...
export default {
  ...
  data() {
    return {
      ...
      datatable: {
        headers: [
          {
            text: this.$t("ROOM.SEARCH.NAME_TH"),
            value: "name_TH",
            align: "center",
          },
          {
            text: this.$t("ROOM.SEARCH.NAME_EN"),
            value: "name_EN",
            align: "center",
          },
          {
            text: this.$t("ROOM.SEARCH.ROOMTYPE"),
            value: "roomTypeName",
            align: "center",
          },
          //                     {
          //   text: this.$t("ROOM.SEARCH.QTY"),
          //   value: "qty",
          //   align: "center",
          // },
          {
            text: this.$t("ROOM.SEARCH.CAPACITY"),
            value: "capacity",
            align: "center",
          },
          //                     {
          //   text: this.$t("ROOM.SEARCH.PRICE"),
          //   value: "price",
          //   align: "center",
          // },
          {
            text: this.$t("ROOM.SEARCH.FACILITY"),
            value: "facility",
            align: "center",
          },
          {
            text: this.$t("LOCATION_TPYE.SEARCH.IN_ACTIVE_STATUS"),
            value: "inActiveStatus",
            align: "center",
          },
          {
            text: this.$t("LOCATION_TPYE.SEARCH.ACTION"),
            value: "id",
            align: "center",
            sortable: false,
            width: "10%",
  ...
  methods: {
    ...
    getDataFromApi() {
      ...
      return new Promise((resolve) => {
        ApiService.setHeader();
        ApiService.post("/Api/Room/Search", {
    ...
    confirmDeleteItem() {
      ...
      ApiService.setHeader();
      ApiService.update("/Api/Room", this.datatable.deleteDialogId + "/Delete")
        .then(({ data }) => {
          //console.log(data);
          this.datatable.dialog = true;
          if (data.message) {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [
      { title: this.$t("ROOM._ROOM.SECTION"), route: "/Room" },
      { title: this.$t("ROOM._ROOM.SEARCH") },
    ]);
  },
  computed: {
    title() {
      return this.$t("ROOM._ROOM.SEARCH");
    },
  },
  watch: {
    "datatable.options": {
